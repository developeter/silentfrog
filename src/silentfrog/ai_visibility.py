...
_AI_VISIBILITY_CHECK_TOOLTIPS = {
    ...
    "gsc_impressions_present": (
        ...
        "Connect via Settings → Connect Google, or set SILENTFROG_GOOGLE_ENABLE=1 + "
        "SILENTFROG_GSC_SITE_URL for headless use. Not connected => info; never penalises the score."
    ),
    ...
    "ga4_engagement_above_median": (
        ...
        "Connect Google, or set SILENTFROG_GOOGLE_ENABLE=1 + SILENTFROG_GA4_PROPERTY_ID for "
        "headless use. Not connected => info."
    ),
