    ...
    return CrawlPayload.from_raw(
        {
            ...
            "images": [["https://example.com/img.png", "Alt", "Title", "image/png", "640", "320", "42 KB", "30m", "Lazy", "High"]],
            "links": [["https://example.com/target", "Anchor", "Interno", "follow", "200", "OK", "Body", "Main Heading", "com"]],
            "schema": {
                "summary": {"total": 1, "by_type": {"Product": 1}, "errors": ["missing price"]},
                "blocks": [{"@type": "Product", "name": "Widget", "_extracted_via": "json-ld", "_schema_errors": ["missing price"]}],
                "eligibility": [{"type": "Product", "detected": True, "count": 1, "eligibility": "Incomplete", "missing_fields": ["offers"], "warnings": ["missing price"]}],
                "issues": [],
            },
            ...
            "serp": {"title": "Duplicate Title", "description": "", "url": url, "site_name": "", "breadcrumb": "", "favicon": ""},
            "serp_audit": {"too_long": "No", "too_short": "Yes", "px_over": "No", "px_under": "Yes", "equals_h1": "Yes", "missing": "No", "px_len": "120", "char_len": "15"},
            "keywords": [{"term": "design table", "length": 2, "frequency": 3, "density": 1.5, "in_title": True, "in_description": False, "heading_count": 1, "first_position": 4}],
            "content_quality": {"language": "en", "word_count": 250, "paragraph_count": 4, "substantial_paragraph_count": 3, "average_words_per_paragraph": 62.5, "title_present": True, "meta_description_present": False, "h1_count": 1, "h2_h6_count": 2, "title_h1_alignment": "Aligned", "intro_paragraph": "Present", "thin_content_risk": "Low", "heading_structure": "Good", "verdict": "Strong"},
            "ai_visibility": {
                "summary": {"verdict": "Needs work", "good_count": 1, "warning_count": 1, "critical_count": 0},
            ...
            "performance": {
                ...
                "nav_total_ms": 456,
                "transfer_size": 2048,
                "summary": {"verdict": "Needs work", "transfer_size": 2048, "total_resource_bytes": 4096, "total_page_bytes": 6144, "total_resource_count": 2, "third_party_bytes": 0, "third_party_count": 0, "critical_issue_count": 0, "warning_issue_count": 1, "info_issue_count": 0},
                "resource_breakdown": [{"type": "img", "count": 1, "bytes": 4096}],
                "issues": [{"key": "image_weight", "severity": "warning", "message": "Large image", "evidence": "Measured image weight is high.", "recommendation": "Compress image assets."}],
                "opportunity_details": [{"message": "Use next-gen image formats.", "severity": "warning"}],
                "top_offenders": [{"type": "img", "url": "https://example.com/img.png", "bytes": 4096, "blocking": False}],
                "scripts": {"blocking": {"count": 1, "bytes": 512}, "async": {"count": 2, "bytes": 1024}},
            },
            "social": {
                "open_graph": {"title": "OG title", "description": "OG description", "image": "https://example.com/og.png", "card": "", "image_type": "image/png", "image_width": 1200, "image_height": 630, "issues": []},
                "twitter": {"title": "TW title", "description": "TW description", "image": "https://example.com/tw.png", "card": "summary_large_image", "image_type": "image/png", "image_width": 1200, "image_height": 630, "issues": ["missing alt"]},
            },
        }
    )
